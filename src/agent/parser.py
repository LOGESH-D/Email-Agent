"""
agent/parser.py — Email Parser.

Parses raw email dict and returns formatted fields.
"""
...
def parse_email(state: dict[str, Any]) -> dict[str, Any]:
    """Parse raw_email and return only parsed fields."""
